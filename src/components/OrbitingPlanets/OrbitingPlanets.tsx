...
export default function OrbitingPlanets({
  ...
  return (
    ...
    <svg ref={planetRef} className="orbiting-planets" height="797" width="900" viewBox="0 0 900 797" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle id="orbit1" className='orbit' cx="93" cy="93" r="91.5" transform="matrix(-1 0 0 1 491.434 304.82)" stroke="#F1F1F1" strokeWidth="3" strokeDasharray="7.43 7.43"></circle>
      <circle id="orbit2" className='orbit' cx="228" cy="228" r="226.5" transform="matrix(-1 0 0 1 626 170.254)" stroke="#F1F1F1" strokeWidth="3" strokeDasharray="7.43 7.43"></circle>
      <circle id="orbit3" className='orbit' cx="285" cy="285" r="283.5" transform="matrix(-1 0 0 1 683.992 113.004)" stroke="#F1F1F1" strokeWidth="3" strokeDasharray="7.43 7.43"></circle>
      <circle id="orbit4" className='orbit' cx="398.5" cy="398.5" r="397" transform="matrix(-1 0 0 1 797 0)" stroke="#F1F1F1" strokeWidth="3" strokeDasharray="7.43 7.43"></circle>
      <g ref={yellowPlanetRef} id="planet1-yellow" className='planet'>
      ...
      <g ref={redPlanetRef} id="planet2-red" className='planet'>
        <g id="Mask group_4">
      ...
      <g ref={purplePlanetRef} id="planet3-purple" className='planet'>
      ...
      <g ref={bluePlanetRef} id="planet4-blue" className='planet'>
